	    		...
	    		if ("foto".contentEquals(choose)) {
	        		...
	        		while (true) {
		        		...
		        		if ("salvarmj".contentEquals(choose)) {
		        			...
		        			break; 
		        		} else if ("salvarcriancas".contentEquals(choose)){ 
	        	...
	        	//2º ramificação do capitulo 1 
	        		...
	        		while (true) {
		        		...
		        		if ("sim".contentEquals(choose)) { 
			        		...
			        		countDown();
			        		System.out.println("=====================================================================================");
			        		//Inicia batalha 1 do capitulo 4
			        		...
			        		"[Não] => \n"});
			        		//Capitulo 7 Final 1 
			        		Capitulo capitulo7 = new Capitulo(new String[] {
			        		...
			        		//Capitulo 8 Final 2
			        		Capitulo capitulo8 = new Capitulo(new String[] {
			        		...
			        		while (true) {
			        			if ("sim".contentEquals(choose)) {
			        				capitulo7.display(0, false);
			        				break;
			        			} else if ("não".contentEquals(choose)) {
			        				capitulo8.display(0, false);
			        				break;
			        			} else { 
			        				System.out.println("Escolha Invalida!!");
			        				TimeUnit.SECONDS.sleep(5);

...
public class Fight {
	...
	public void start(Character personagem1, Character personagem2, int tipo) throws InterruptedException {
		...
		//Variavel para que a habilidade digitada é valida!
		boolean habilityFound = false; 
		//A luta vai rolar até um dos personagens morrer
		...
		while (true) {
			...
			if (tipo == 1) {
				...
				if (personagem2.getHP() >= hpPersonagem2/2) {
					...
					System.out.println("-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-");
					System.out.printf("  Após uma luta muito violenta e cheia de destruição, o %s conseguiu fugir\n", personagem2.getName());
					System.out.println("-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-");
					break;
				}
			}
			...
			//Ataque da máquina, garantindo que o personagem vai está vivo para atacar
			...
			//Exibindo a morte trágica de um dos personagens
			if (personagem2.getName().contentEquals("Lutador") && (personagem2.getHP() == 0)){
				System.out.printf("-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-\n");
				...
				System.out.printf("-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-\n");
				System.out.printf("%s foi fatalmente derrotado, infelizmente não sobreviveu ao incrível Spider Man\n", personagem2.getName());
				System.out.printf("-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-\n");
				TimeUnit.SECONDS.sleep(10);
			} 
		}

	        	...
	        	//ramificação 2 
	        		...
	        		while (true) {
		        		...
		        		if ("sim".contentEquals(choose)) { 
			        		...
			        		"Peter se encontra numa situação constrangedora em que uma pessoa\n"+
			        		"no metrô tenta lhe constranger, o que ele deve fazer?\n"+
			        		"[revidar] => (Peter responde à altura e se defende!)\n"+
			        		"[sair] => (Ele vai embora fingindo que nada aconteceu\n"});
			        		
			        		while(true) {
			        			choose = capitulor1.display(0,true);
			        	   		
			            		
			            		if ("revidar".contentEquals(choose)) {
			            			System.out.println("Peter se levanta de onde estava sentado, mas por ser desastrado e ainda estar se adaptando aos poderes acaba gerando uma confusão no metrô.\n");
			            			break;
			            		} else if("comer".contentEquals(choose)) {
			            			System.out.println("Peter foi embora fingindo que nada aconteceu e a situação se encerrou por aí.\n");
			            			break;
			            		} else {
			            			System.out.println("Escolha invalida!");
			            			TimeUnit.SECONDS.sleep(5);
			        		...
			        		"e seu telefone começa a tocar, você sabe que recusou diversas\n"+
			        		"ligações dele, e agora terá que lhe dar explicações, o que o Peter deve fazer?\n"+
			        		"[Mentir] => (Peter não atende o telefone e mente sobre não ter visto as ligações)\n"+
			        		"[Explicar] => (Ele explica que perdeu a noção do tempo porque estava na Oscorp com o Dr. Connors\n"});
			        		
			        		while(true) {
			        			choose = capitulor2.display(0,true);
			        	   		
			            		
			            		if ("mentir".contentEquals(choose)) {
			            			System.out.println("O tio Ben sempre sabe quando ele fala a verdade ou não, Peter se deu mal.\n");
			            			break;
			            		} else if("comer".contentEquals(choose)) {
			            			System.out.println("O tio Ben entende que aquilo era importante para ele, mas dá um sermão ao Peter sobre responsabilidade.\n");
			            			break;
			            		} else {
			            			System.out.println("Escolha invalida!");
			            			TimeUnit.SECONDS.sleep(5);
			        		...
			        		"par seus tios ou não, ele sabe que pode por eles em perigo\n"+
			        		"mas se sente mal em esconder segredo dos seus tios, o que ele deve fazer?\n"+
			        		"[Contar] => (Peter explica aos seus tios ssobre os poderes se sobre sua intenção de ser um herói)\n"+
			        		"[Esconder] => (Ele prefere a segurança dos seus tios ao invés de ser sincero com eles\n"});
			        		
			        		while(true) {
			        			choose = capitulor3.display(0,true);
			        		...
			        		"apenas um cara que estava comendo sozinho, estava rodeado de pessoas\n"+
			        		"que torciam pelo flash. Ao se aproximar, o Flash ordena que o Peter tire\n"+
			        		"uma foto sua humilhando aquele rapaz, mas ele não quer fazer isso\n"+
			        		"porém ele também sabe que se não tirar a foto vai ter o mesmo fim do pobre rapaz\n"+
			        		"o que ele deve fazer?\n"+
			        		"[Fotografar] => (Peter Tira a foto por medo de apanhar)\n"+
			        		"[Negar] => (Ele não tira a foto\n"});
			        		
			        		while(true) {
			        			choose = capitulor4.display(0,true);
			        		...
			        		"que imediatamente notam seus machucados no rosto e perguntam o que aconteceu\n"+
			        		"ele fica em dúvida se conta a verdade ou se diz que apenas 'caiu do skate'\n"+
			        		"o que ele deve fazer?\n"+
			        		"[Explicar] => (Peter fala a verdade)\n"+
			        		"[Mentir] => (Ele esconde a verdade dos seus tios\n"});
			        		
			        		while(true) {
			        			choose = capitulor5.display(0,true);
			        	   		
			            		
			            		if ("explicar".contentEquals(choose)) {
			            			System.out.println("Peter fala a verdade e explica o que aconteceu, e seu Tio bem vai imediatamente na escola tomar providências.\n");
			            			break;
			            		} else if("mentir".contentEquals(choose)) {
			            			System.out.println("Ele diz que caiu do skate apenas, seus tios sabem que não é verdade mas decidem ignorar o que aconteceu.\n");  
			            			break;
			            		} else {
			            			System.out.println("Escolha invalida!");
			            			TimeUnit.SECONDS.sleep(5);
